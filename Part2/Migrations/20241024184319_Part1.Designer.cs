...
namespace Part1.Migrations
{
    ...
    [Migration("20241024184319_Part1")]
    partial class Part1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Part1.Models.AcademicManager", b =>
                {
            ...
            modelBuilder.Entity("Part1.Models.ApprovalProcess", b =>
                {
            ...
            modelBuilder.Entity("Part1.Models.Claims", b =>
                {
                    b.Property<int>("ClaimID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Part1.Models.ClaimsModules", b =>
                {
                    b.Property<int>("ClaimID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Part1.Models.Lecturer", b =>
                {
                    b.Property<int>("LecturerID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Part1.Models.Module", b =>
                {
                    b.Property<string>("ModuleCode")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Part1.Models.ProgrammeCoordinator", b =>
                {
                    b.Property<int>("CoordinatorID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Part1.Models.SupportingDocuments", b =>
                {
            ...
            modelBuilder.Entity("Part1.Models.Users", b =>
                {
            ...
            modelBuilder.Entity("Part1.Models.ApprovalProcess", b =>
                {
                    b.HasOne("Part1.Models.Claims", "Claims")
                        .WithMany("ApprovalProcesses")
                        .HasForeignKey("ClaimID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Part1.Models.ProgrammeCoordinator", "Coordinator")
                        .WithMany("ApprovalProcesses")
                        .HasForeignKey("CoordinatorID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Part1.Models.AcademicManager", "Manager")
                        .WithMany("ApprovalProcesses")
            ...
            modelBuilder.Entity("Part1.Models.Claims", b =>
                {
                    b.HasOne("Part1.Models.Lecturer", "Lecturer")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Part1.Models.ClaimsModules", b =>
                {
                    ...
                    b.HasOne("Part1.Models.Module", "Module")
                        .WithMany("ClaimsModules")
